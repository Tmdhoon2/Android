...
fun <T> varargsFun(a1: Int, vararg array:T){    // vararg : 가변인수
    for(a in array){                            // 인수의 개수, 타입에 상관없이 아무렇게나 함수 호출
        println(a)
    }
}

fun main2(){
    varargsFun(10, "hello", "world")    // array : "hello", "world"
    varargsFun(10, 20, false)           // array : 20, false
}

fun recPrint(no: Int = 1, count: Int = 1){        // 재귀함수
    println("recPrint..")
...
tailrec fun tailrecPrint(no: Int = 1, count: Int = 1){  // tailrec 키워드가 붙은 재귀함수
